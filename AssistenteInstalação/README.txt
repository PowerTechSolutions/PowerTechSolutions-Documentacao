# Guia de Configuração PowerTech para EC2

Este é um assistente virtual em forma de script shell que automatiza a configuração de uma interface gráfica em uma instância EC2 da AWS para facilitar o acesso aos dados da máquina por meio de uma interface gráfica. O Assistente PowerTech é projetado para simplificar o processo de configuração.
...
## Licença
Este projeto está licenciado sob a Licença PowerTech. 
